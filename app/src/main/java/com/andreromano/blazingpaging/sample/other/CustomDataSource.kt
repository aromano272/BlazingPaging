...
class CustomDataSource<Data : Any>(private val fetch: suspend (page: Int, pageSize: Int) -> ResultKt<List<Data>>) : DataSource<Int, Data, ErrorKt>() {
    override suspend fun fetchPage(key: Int, pageSize: Int): FetchResult<Int, Data, ErrorKt> =
...
class StringDataSource(private val fetch: suspend (key: String, pageSize: Int) -> ResultKt<GetUsersResponse> = ::getUsers) : DataSource<String, Data, ErrorKt>() {
    override suspend fun fetchPage(key: String, pageSize: Int): FetchResult<String, Data, ErrorKt> = when (val result = fetch(key, pageSize)) {
